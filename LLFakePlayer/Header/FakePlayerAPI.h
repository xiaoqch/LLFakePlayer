...
FPAPI SimulatedPlayer* createAt(std::string const& name, std::pair<BlockPos, int> pos);
FPAPI SimulatedPlayer* createAt(std::string const& name, int x, int y, int z, int dimid);
